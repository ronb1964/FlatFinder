...
import { ResponsiveContainer, ScalableH2 } from '../../src/components/responsive';
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView>
          <ResponsiveContainer maxWidth="lg">
            <YStack space="$4" paddingVertical="$4" $md={{ space: '$5', paddingVertical: '$6' }}>
              ...
              <YStack space="$3">
                ...
                <SettingRow
                  icon={
                    <Vibrate size={20} color={settings.hapticsEnabled ? '#10b981' : '#ffffff'} />
                  }
                    ...
                    >
                      <YStack space="$3">
                        ...
                        <RadioGroup
                          ...
                          onValueChange={(value: string) =>
                            updateSettings({
                              audioSensitivity: value as 'conservative' | 'normal' | 'frequent',
                            })
                          }
                        >
                          <YStack space="$2">
              ...
              <YStack space="$3">
                ...
                >
                  <ColoredSwitch
                    ...
                    onCheckedChange={(checked: boolean) => updateSettings({ nightMode: checked })}
                    color="$indigo9"
                  />
                </SettingRow>
                ...
                <SettingRow
                  icon={
                    <Activity
                      size={20}
                      color={settings.keepAwake ? '#f97316' : theme.color?.val || '#fff'}
                    />
                  }
                ...
                >
                  <ColoredSwitch
                    ...
                    onCheckedChange={(checked: boolean) => updateSettings({ keepAwake: checked })}
                    color="$orange9"
                  />
                </SettingRow>
              </YStack>
                ...
                >
                  <YStack space="$3">
                    ...
                    <Button
                      ...
                      onPress={() => {
                        resetOnboarding();
                        // Reload page on web only — on native the state change triggers re-render automatically
                        if (
                          Platform.OS === 'web' &&
                          ...
                          (window as Window).location.reload(); // eslint-disable-line no-undef
                        }
                      }}
                    >
                      Reset & Restart
